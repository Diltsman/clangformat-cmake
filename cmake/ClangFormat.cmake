...
function(target_clangformat_setup target)
  ...
  get_target_property(target_modules ${target} CXX_MODULE_SET)

  set(all_target_files "")
  if(NOT "${target_sources}" STREQUAL "target_sources-NOTFOUND")
    list(APPEND all_target_files ${target_sources})
  endif()
  if(NOT "${target_headers}" STREQUAL "target_headers-NOTFOUND")
    list(APPEND all_target_files ${target_headers})
  endif()
  if(NOT "${target_modules}" STREQUAL "target_modules-NOTFOUND")
    list(APPEND all_target_files ${target_modules})
  endif()
  prefix_clangformat_setup(${target} ${all_target_files})
endfunction()
